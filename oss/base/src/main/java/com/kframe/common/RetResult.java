...
public class RetResult<T> {
    ...
    public static <T> CompletableFuture<RetResult> successFuture() {
     ...
     * @return RetResult
     */
    public RetResult<T> attach(String key, String value) {
        if (this.attach == null) this.attach = new HashMap<String, String>();
	...
	public String toString() {
		return "RetResult [retcode=" + retcode + ", retinfo=" + retinfo + ", result=" + result + ", attach=" + attach
				+ "]";
	}
